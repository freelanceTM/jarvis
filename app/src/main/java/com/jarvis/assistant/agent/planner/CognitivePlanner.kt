...
open class CognitivePlanner @Inject constructor(
    ...
    fun planForGoal(userPrompt: String, llmRawOutput: String? = null): ExecutionPlan? {
        ...
        // =========================================================================
        if (scenario == ScenarioId.LEAVING_HOME) {
            return ExecutionPlan(
        ...
        // =========================================================================
        if (scenario == ScenarioId.COMING_HOME) {
            return ExecutionPlan(
        ...
        // =========================================================================
        if (scenario == ScenarioId.MORNING) {
            return ExecutionPlan(
        ...
        // =========================================================================
        if (scenario == ScenarioId.MEETING) {
            return ExecutionPlan(
        ...
        // =========================================================================
        if (scenario == ScenarioId.DRIVING) {
            return ExecutionPlan(
                goal = "Режим вождения",
        ...
        // =========================================================================
        if (scenario == ScenarioId.POWER_SAVING) {
            return ExecutionPlan(
        ...
        // =========================================================================
        if (scenario == ScenarioId.DIAGNOSTICS) {
            return ExecutionPlan(
        ...
        // =========================================================================
        if (scenario == ScenarioId.PRESENTATION) {
            return ExecutionPlan(
